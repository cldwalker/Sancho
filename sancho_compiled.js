...
*/
lt.plugins.sancho.util.exec_commands = (function exec_commands(commands){var seq__8675 = cljs.core.seq.call(null,commands);var chunk__8676 = null;var count__8677 = 0;var i__8678 = 0;while(true){
if((i__8678 < count__8677))
{var c = cljs.core._nth.call(null,chunk__8676,i__8678);if(cljs.core.coll_QMARK_.call(null,c))
...
{var c__7112__auto__ = cljs.core.chunk_first.call(null,seq__8675__$1);{
var G__8683 = cljs.core.chunk_rest.call(null,seq__8675__$1);
var G__8684 = c__7112__auto__;
var G__8685 = cljs.core.count.call(null,c__7112__auto__);
var G__8686 = 0;
seq__8675 = G__8683;
chunk__8676 = G__8684;
count__8677 = G__8685;
...
{var c = cljs.core.first.call(null,seq__8675__$1);if(cljs.core.coll_QMARK_.call(null,c))
{cljs.core.apply.call(null,lt.objs.command.exec_BANG_,c);
} else
{lt.objs.command.exec_BANG_.call(null,c);
}
...
lt.plugins.sancho.__GT_grimoire_examples_url = cljs.core.comp.call(null,(function (p1__8723_SHARP_){return [cljs.core.str(p1__8723_SHARP_),cljs.core.str("/examples")].join('');
}),lt.plugins.sancho.__GT_grimoire_url);
/**
* Performs given action on a stringified, resolved var e.g. #'clojure.core/cond
*/
lt.plugins.sancho.for_resolved_var = (function for_resolved_var(action,info,p__8724){var map__8728 = p__8724;var map__8728__$1 = ((cljs.core.seq_QMARK_.call(null,map__8728))?cljs.core.apply.call(null,cljs.core.hash_map,map__8728):map__8728);var result = cljs.core.get.call(null,map__8728__$1,new cljs.core.Keyword(null,"result","result",4374444943));try{var vec__8730 = cljs.core.re_find.call(null,/^#'(\S+)\/(\S+)$/,result);var _ = cljs.core.nth.call(null,vec__8730,0,null);var ns = cljs.core.nth.call(null,vec__8730,1,null);var var$ = cljs.core.nth.call(null,vec__8730,2,null);if(cljs.core.truth_((function (){var and__6352__auto__ = ns;if(cljs.core.truth_(and__6352__auto__))
{return var$;
} else
...
{var e = e8729;return lt.objs.notifos.set_msg_BANG_.call(null,[cljs.core.str(e)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",1108647146),"error"], null));
} else
...
lt.plugins.sancho.fetch_and_open_grimoire_examples_STAR_ = (function fetch_and_open_grimoire_examples_STAR_(p__8731){var map__8733 = p__8731;var map__8733__$1 = ((cljs.core.seq_QMARK_.call(null,map__8733))?cljs.core.apply.call(null,cljs.core.hash_map,map__8733):map__8733);var url = cljs.core.get.call(null,map__8733__$1,new cljs.core.Keyword(null,"url","url",1014020321));var var$ = cljs.core.get.call(null,map__8733__$1,new cljs.core.Keyword(null,"var","var",1014020761));var ns = cljs.core.get.call(null,map__8733__$1,new cljs.core.Keyword(null,"ns","ns",1013907767));lt.objs.notifos.working.call(null);
return lt.plugins.sancho.util.GET.call(null,url,((function (map__8733,map__8733__$1,url,var$,ns){
return (function (body){var path_8734 = lt.plugins.sancho.util.tempfile.call(null,[cljs.core.str(ns),cljs.core.str("-"),cljs.core.str(var$)].join(''),".clj");lt.objs.files.save.call(null,path_8734,body);
lt.objs.command.exec_BANG_.call(null,new cljs.core.Keyword(null,"open-path","open-path",2513940794),path_8734);
return lt.objs.notifos.done_working.call(null);
});})(map__8733,map__8733__$1,url,var$,ns))
);
});
