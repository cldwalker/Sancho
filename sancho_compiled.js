...
goog.require('lt.object');
lt.plugins.sancho.eval.handle = (function (){var method_table__7223__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var prefer_table__7224__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var method_cache__7225__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var cached_hierarchy__7226__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var hierarchy__7227__auto__ = cljs.core.get.call(null,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",3129050535),cljs.core.get_global_hierarchy.call(null));return (new cljs.core.MultiFn("handle",((function (method_table__7223__auto__,prefer_table__7224__auto__,method_cache__7225__auto__,cached_hierarchy__7226__auto__,hierarchy__7227__auto__){
return (function (info,_){return new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(info);
});})(method_table__7223__auto__,prefer_table__7224__auto__,method_cache__7225__auto__,cached_hierarchy__7226__auto__,hierarchy__7227__auto__))
,new cljs.core.Keyword(null,"default","default",2558708147),hierarchy__7227__auto__,method_table__7223__auto__,prefer_table__7224__auto__,method_cache__7225__auto__,cached_hierarchy__7226__auto__));
})();
...
*/
lt.plugins.sancho.util.exec_commands = (function exec_commands(commands){var seq__7943 = cljs.core.seq.call(null,commands);var chunk__7944 = null;var count__7945 = 0;var i__7946 = 0;while(true){
if((i__7946 < count__7945))
{var c = cljs.core._nth.call(null,chunk__7944,i__7946);if(cljs.core.coll_QMARK_.call(null,c))
{cljs.core.apply.call(null,lt.objs.command.exec_BANG_,c);
} else
{lt.objs.command.exec_BANG_.call(null,c);
}
{
var G__7947 = seq__7943;
var G__7948 = chunk__7944;
var G__7949 = count__7945;
var G__7950 = (i__7946 + 1);
seq__7943 = G__7947;
chunk__7944 = G__7948;
count__7945 = G__7949;
i__7946 = G__7950;
...
{var temp__4126__auto__ = cljs.core.seq.call(null,seq__7943);if(temp__4126__auto__)
{var seq__7943__$1 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__7943__$1))
{var c__7113__auto__ = cljs.core.chunk_first.call(null,seq__7943__$1);{
var G__7951 = cljs.core.chunk_rest.call(null,seq__7943__$1);
var G__7952 = c__7113__auto__;
var G__7953 = cljs.core.count.call(null,c__7113__auto__);
var G__7954 = 0;
seq__7943 = G__7951;
chunk__7944 = G__7952;
count__7945 = G__7953;
...
{var c = cljs.core.first.call(null,seq__7943__$1);if(cljs.core.coll_QMARK_.call(null,c))
{cljs.core.apply.call(null,lt.objs.command.exec_BANG_,c);
} else
{lt.objs.command.exec_BANG_.call(null,c);
}
{
var G__7955 = cljs.core.next.call(null,seq__7943__$1);
var G__7956 = null;
var G__7957 = 0;
var G__7958 = 0;
seq__7943 = G__7955;
...
lt.plugins.sancho.__GT_grimoire_examples_url = cljs.core.comp.call(null,(function (p1__8291_SHARP_){return [cljs.core.str(p1__8291_SHARP_),cljs.core.str("/examples")].join('');
}),lt.plugins.sancho.__GT_grimoire_url);
/**
* Performs given action on a stringified, resolved var e.g. #'clojure.core/cond
*/
lt.plugins.sancho.for_resolved_var = (function for_resolved_var(action,info,p__8292){var map__8296 = p__8292;var map__8296__$1 = ((cljs.core.seq_QMARK_.call(null,map__8296))?cljs.core.apply.call(null,cljs.core.hash_map,map__8296):map__8296);var result = cljs.core.get.call(null,map__8296__$1,new cljs.core.Keyword(null,"result","result",4374444943));try{var vec__8298 = cljs.core.re_find.call(null,/^(\S+)\/(\S+)$/,result);var _ = cljs.core.nth.call(null,vec__8298,0,null);var ns = cljs.core.nth.call(null,vec__8298,1,null);var var$ = cljs.core.nth.call(null,vec__8298,2,null);if(cljs.core.truth_((function (){var and__6353__auto__ = ns;if(cljs.core.truth_(and__6353__auto__))
{return var$;
} else
...
}catch (e8297){if((e8297 instanceof Error))
{var e = e8297;return lt.objs.notifos.set_msg_BANG_.call(null,[cljs.core.str(e)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",1108647146),"error"], null));
} else
...
lt.plugins.sancho.fetch_and_open_grimoire_examples_STAR_ = (function fetch_and_open_grimoire_examples_STAR_(p__8299){var map__8301 = p__8299;var map__8301__$1 = ((cljs.core.seq_QMARK_.call(null,map__8301))?cljs.core.apply.call(null,cljs.core.hash_map,map__8301):map__8301);var url = cljs.core.get.call(null,map__8301__$1,new cljs.core.Keyword(null,"url","url",1014020321));var var$ = cljs.core.get.call(null,map__8301__$1,new cljs.core.Keyword(null,"var","var",1014020761));var ns = cljs.core.get.call(null,map__8301__$1,new cljs.core.Keyword(null,"ns","ns",1013907767));lt.objs.notifos.working.call(null);
return lt.plugins.sancho.util.GET.call(null,url,((function (map__8301,map__8301__$1,url,var$,ns){
return (function (body){var path_8302 = lt.plugins.sancho.util.tempfile.call(null,[cljs.core.str(ns),cljs.core.str("-"),cljs.core.str(var$)].join(''),".clj");lt.objs.files.save.call(null,path_8302,body);
lt.objs.command.exec_BANG_.call(null,new cljs.core.Keyword(null,"open-path","open-path",2513940794),path_8302);
return lt.objs.notifos.done_working.call(null);
});})(map__8301,map__8301__$1,url,var$,ns))
);
});
