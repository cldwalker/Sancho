...
lt.plugins.sancho.__GT_grimoire_examples_url = cljs.core.comp.call(null,(function (p1__8711_SHARP_){return [cljs.core.str(p1__8711_SHARP_),cljs.core.str("/examples")].join('');
}),lt.plugins.sancho.__GT_grimoire_url);
/**
* Performs given action on a stringified, resolved var e.g. #'clojure.core/cond
*/
lt.plugins.sancho.for_resolved_var = (function for_resolved_var(action,info,p__8712){var map__8716 = p__8712;var map__8716__$1 = ((cljs.core.seq_QMARK_.call(null,map__8716))?cljs.core.apply.call(null,cljs.core.hash_map,map__8716):map__8716);var result = cljs.core.get.call(null,map__8716__$1,new cljs.core.Keyword(null,"result","result",4374444943));try{var vec__8718 = cljs.core.re_find.call(null,/^#'(\S+)\/(\S+)$/,result);var _ = cljs.core.nth.call(null,vec__8718,0,null);var ns = cljs.core.nth.call(null,vec__8718,1,null);var var$ = cljs.core.nth.call(null,vec__8718,2,null);if(cljs.core.truth_((function (){var and__6352__auto__ = ns;if(cljs.core.truth_(and__6352__auto__))
{return var$;
} else
...
{var e = e8717;return lt.objs.notifos.set_msg_BANG_.call(null,[cljs.core.str(e)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",1108647146),"error"], null));
} else
...
lt.plugins.sancho.fetch_and_open_grimoire_examples_STAR_ = (function fetch_and_open_grimoire_examples_STAR_(p__8719){var map__8721 = p__8719;var map__8721__$1 = ((cljs.core.seq_QMARK_.call(null,map__8721))?cljs.core.apply.call(null,cljs.core.hash_map,map__8721):map__8721);var url = cljs.core.get.call(null,map__8721__$1,new cljs.core.Keyword(null,"url","url",1014020321));var var$ = cljs.core.get.call(null,map__8721__$1,new cljs.core.Keyword(null,"var","var",1014020761));var ns = cljs.core.get.call(null,map__8721__$1,new cljs.core.Keyword(null,"ns","ns",1013907767));lt.objs.notifos.working.call(null);
return lt.plugins.sancho.util.GET.call(null,url,((function (map__8721,map__8721__$1,url,var$,ns){
return (function (body){var path_8722 = lt.plugins.sancho.util.tempfile.call(null,[cljs.core.str(ns),cljs.core.str("-"),cljs.core.str(var$)].join(''),".clj");lt.objs.files.save.call(null,path_8722,body);
lt.objs.command.exec_BANG_.call(null,new cljs.core.Keyword(null,"open-path","open-path",2513940794),path_8722);
return lt.objs.notifos.done_working.call(null);
});})(map__8721,map__8721__$1,url,var$,ns))
);
});
